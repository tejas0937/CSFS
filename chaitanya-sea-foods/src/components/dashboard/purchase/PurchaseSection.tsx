...
export default function PurchaseSection({
  purchaseDate, canCreate, onAddProduct, canEditProducts, canOverrideNetWeight, role, vendors, selectedVendorId, selectedProductId, selectedVendor, selectedProduct,
